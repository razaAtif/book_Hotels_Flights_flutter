...
import 'package:book_tickets/widgets/thick_conatiner.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: AppLayout.getHeight(GetPlatform.isAndroid == true ? 156 : 169),
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            /* showing bottom part of orange ticket */
            Container(
              decoration: BoxDecoration(
                color: isColor == null ? Styles.orangeColor : Colors.white,
                borderRadius: BorderRadius.only(
